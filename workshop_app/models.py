...
# Auto-create a Profile for any new User (helps superusers/admins login)
@receiver(post_save, sender=User)
def ensure_user_profile_exists(sender, instance, created, **_):
    if created:
        # Provide sane defaults to satisfy validators
        ...
        # If profile missing for older users, create on the fly
